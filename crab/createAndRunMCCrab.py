...
datasets = {
    ...
    #new datasets
    #"/G_Pt-30to50_TuneZ2star_8TeV_pythia6/Summer12_DR53X-PU_RD1_START53_V7N-v1/AODSIM"     : "G_Pt-30to50",     
    #"/G_Pt-50to80_TuneZ2star_8TeV_pythia6/Summer12_DR53X-PU_RD1_START53_V7N-v1/AODSIM"     : "G_Pt-50to80",     
    #"/G_Pt-80to120_TuneZ2star_8TeV_pythia6/Summer12_DR53X-PU_RD1_START53_V7N-v1/AODSIM"    : "G_Pt-80to120",    
    #"/G_Pt-120to170_TuneZ2star_8TeV_pythia6/Summer12_DR53X-PU_RD1_START53_V7N-v1/AODSIM"   : "G_Pt-120to170",   
    #"/G_Pt-170to300_TuneZ2star_8TeV_pythia6/Summer12_DR53X-PU_RD1_START53_V7N-v1/AODSIM"   : "G_Pt-170to300",   
    #"/G_Pt-300to470_TuneZ2star_8TeV_pythia6/Summer12_DR53X-PU_RD1_START53_V7N-v1/AODSIM"   : "G_Pt-300to470",   
    "/G_Pt-470to800_TuneZ2star_8TeV_pythia6/Summer12_DR53X-PU_RD1_START53_V7N-v1/AODSIM"   : "G_Pt-470to800",   
    #"/G_Pt-800to1400_TuneZ2star_8TeV_pythia6/Summer12_DR53X-PU_RD1_START53_V7N-v1/AODSIM"  : "G_Pt-800to1400",  
    #"/G_Pt-1400to1800_TuneZ2star_8TeV_pythia6/Summer12_DR53X-PU_RD1_START53_V7N-v1/AODSIM" : "G_Pt-1400to1800", 
    #"/G_Pt-1800_TuneZ2star_8TeV_pythia6/Summer12_DR53X-PU_RD1_START53_V7N-v1/AODSIM"       : "G_Pt-1800",       
...
for dataset_path, dataset_name in datasets.items():
  ...
  output_dir = "/store/group/phys_jetmet/gdimperi/step1/MC/%s/%s" % (d, dataset_name)
  ...
  os.system("sed -e \"s#@datasetname@#%s#\" -e \"s#@uiworkingdir@#%s#g\" -e \"s#@publish_data_name@#%s#g\" -e \"s#@email@#%s#g\" -e \"s#@remote_dir@#%s#g\" crab_MC.cfg.template.ipnl > %s" % (dataset_path, ui_working_dir, publish_name, email, output_dir, output_file))
