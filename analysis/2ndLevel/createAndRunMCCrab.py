...
datasets = [
    ...
    # Gamma + jets (new mc)
    #["/G_Pt-30to50_TuneZ2star_8TeV_pythia6/gdimperi-G_Pt-30to50_START53_V7N_30Jan14-v1-bff4e2252837464ce6defb764cfbdfcf/USER" , "G_Pt-30to50", 30, 50, 1989346, 19931.62],                   
    #["/G_Pt-50to80_TuneZ2star_8TeV_pythia6/gdimperi-G_Pt-50to80_START53_V7N_30Jan14-v1-bff4e2252837464ce6defb764cfbdfcf/USER" , "G_Pt-50to80", 50, 80, 1987771, 3322.309],                   
    #["/G_Pt-80to120_TuneZ2star_8TeV_pythia6/gdimperi-G_Pt-80to120_START53_V7N_30Jan14-v1-bff4e2252837464ce6defb764cfbdfcf/USER" , "G_Pt-80to120", 80, 120, 1978496, 558.2865],               
    ["/G_Pt-120to170_TuneZ2star_8TeV_pythia6/gdimperi-G_Pt-120to170_START53_V7N_30Jan14-v1-bff4e2252837464ce6defb764cfbdfcf/USER" , "G_Pt-120to170", 120, 170, 1979783, 108.0068],      
    #["/G_Pt-170to300_TuneZ2star_8TeV_pythia6/gdimperi-G_Pt-170to300_START53_V7N_30Jan14-v1-bff4e2252837464ce6defb764cfbdfcf/USER" , "G_Pt-170to300", 170, 300, 1977036, 30.12207],        
    #["/G_Pt-300to470_TuneZ2star_8TeV_pythia6/gdimperi-G_Pt-300to470_START53_V7N_30Jan14-v1-bff4e2252837464ce6defb764cfbdfcf/USER", "G_Pt-300to470", 300, 470, 1932591, 2.138632],           
    ["/G_Pt-470to800_TuneZ2star_8TeV_pythia6/gdimperi-G_Pt-470to800_START53_V7N_11Feb14-v1-2c333d1ef9021b887ad40a2d99f57d58/USER" , "G_Pt-470to800", 470, 800, 1939572, 0.2119244],           
    #["/G_Pt-800to1400_TuneZ2star_8TeV_pythia6/gdimperi-G_Pt-800to1400_START53_V7N_30Jan14-v1-bff4e2252837464ce6defb764cfbdfcf/USER" , "G_Pt-800to1400", 800, 1400, 1930757, 0.007077847],    
    #["/G_Pt-1400to1800_TuneZ2star_8TeV_pythia6/gdimperi-G_Pt-1400to1800_START53_V7N_30Jan14-v1-bff4e2252837464ce6defb764cfbdfcf/USER" , "G_Pt-1400to1800", 1400, 1800, 1915469, 4.510327E-5],
    #["/G_Pt-1800_TuneZ2star_8TeV_pythia6/gdimperi-G_Pt-1800_START53_V7N_30Jan14-v1-bff4e2252837464ce6defb764cfbdfcf/USER" , "G_Pt-1800", 1800, 8000, 1822662, 1.867141E-6],                  


    # Gamma + jets (old by sebastien)
...
# Get email address
email = "%s@ipnl.a in2p3.fr" % (pwd.getpwuid(os.getuid()).pw_name)
...
for dataset in datasets:
  ...
  output_dir = "/store/group/phys_jetmet/gdimperi/step2/MC/%s/%s" % (d, dataset_name)
