...
Since for the moment data were not released in MimiAOD format there is a flag in the code for data that allows to run on AOD and produce MiniAODs on-the-fly
...
Create a list of the files to be merged (the output files of Step 1) and then run
[source,bash]
-----
