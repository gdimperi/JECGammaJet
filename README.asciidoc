...
The new analysis code starts from MINIAOD format instad of AOD. MINIAOD basically contains PAT objets: this allow to use basically the old structure skipping Step 1.
