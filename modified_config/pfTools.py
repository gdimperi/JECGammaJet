...
def switchToPFJets(process, input=cms.InputTag('pfNoTau'), algo='AK5', postfix = "", jetCorrections=('AK5PFchs', ['L1FastJet','L2Relative', 'L3Absolute']), type1=False, outputModules=['out']):
    ...
    #----------end edit giulia----------------
        ...
        print 'developing of CA8 jets - Giulia'
        sys.exit(1)

    #debug giulia
    print("### debug giulia ######")
    print("before calling switchJetCollection")
...
#########################################    problem in next line with ca8 jets ?? ######### giulia
    setattr(process,"pfJets"+postfix,jetAlgo(algo)) # problem for cfgBrowse
    print("### debug giulia ######")
    print("before calling switchJetCollection")
    ...
    print("### debug giulia ######")
    print("after calling switchJetCollection, then apply postfix")
